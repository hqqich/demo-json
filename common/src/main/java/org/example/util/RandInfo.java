...
/**
 * Created by ChenHao on 2023/5/28 is 14:55.
 *
 * @author tsinglink
 */
...
public class RandInfo {
	...
	public static String getFamilyName() {
		...
		if (randNum == 1) {
			str = java.lang.String.valueOf(familyName1.charAt(index));
		} else {
	...
	public static String getFullName(boolean flag) {
		String[] name = getNameAndSex(flag ? "男" : "女");
		return getFamilyName() + name[0];
	}
	public static String getFullName() {
		String[] name = getNameAndSex(getSex());
		return getFamilyName() + name[0];
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(getRandomToStr(0d, 10d));
		System.out.println(getRandomToStr(0d, 10d));
	...
	public static String getRandomToStr(Double min, Double max){
		return java.lang.String.valueOf(Math.random() * (max - min) + min);
	}
